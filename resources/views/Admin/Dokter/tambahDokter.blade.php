...
<div class="d-flex align-items-center justify-content-between mb-4 mt-4">
    <h1 class="mb-0" style="border: none !important; padding-bottom: 0 !important; border-image: none !important;">
        <i class="fas fa-user-plus me-2" style="color: #0d9488;"></i>Tambah Data Dokter
    </h1>
</div>

<form action="{{ route('admin.dokter.tambahkan') }}" method="POST">
@csrf
            ...
            <div class="card mb-4" style="border-radius: 1.5rem !important;">
                <div class="card-body p-4">
                    <h6 style="font-weight: 700; color: #0f172a; margin-bottom: 1rem;">
                        <i class="fas fa-user-md me-2" style="color: #0d9488;"></i>Data Dokter Baru
                    </h6>
                    <div class="row mb-3 align-items-center">
                        <div class="col-sm-3"><p class="mb-0" style="font-weight: 600; color: #0f172a; font-size: 0.88rem;">Nama Lengkap</p></div>
                        <div class="col-sm-9"><input type="text" name="nama" class="form-control" placeholder="Nama lengkap dokter" required></div>
                    </div>
                    ...
                    <div class="row mb-3 align-items-center">
                        ...
                        <div class="col-sm-9"><input type="text" name="email" class="form-control" placeholder="email@domain.com" required></div>
                    </div>
                    <hr style="border-color: #f1f5f9; margin: 0.5rem 0;">
                    <div class="row mb-3 align-items-center">
                    ...
                    <div class="row mb-3 align-items-center">
                        ...
                        <div class="col-sm-9"><input type="text" name="spesialisasi" class="form-control" placeholder="Contoh: Bedah, Kulit" required></div>
                    </div>
                    <hr style="border-color: #f1f5f9; margin: 0.5rem 0;">
                    <div class="row mb-3 align-items-center">
