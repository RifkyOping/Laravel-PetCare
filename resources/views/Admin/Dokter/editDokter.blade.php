                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="nama" value="{{ $dataDokter->dokter->nama }}" class="form-control" required>
                            </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="email" value="{{ $dataDokter->email }}" class="form-control" required>
                                </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="no_telepon" value="{{ $dataDokter->dokter->no_telepon }}" class="form-control" required>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="alamat" value="{{ $dataDokter->dokter->alamat }}" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="spesialisasi" value="{{ $dataDokter->dokter->spesialisasi }}" class="form-control" required>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
