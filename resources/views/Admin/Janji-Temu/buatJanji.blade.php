...
<div class="d-flex align-items-center justify-content-between mb-4 mt-4">
    <h1 class="mb-0" style="border: none !important; padding-bottom: 0 !important; border-image: none !important;">
        <i class="fas fa-calendar-plus me-2" style="color: #0d9488;"></i>Buat Janji Temu
    </h1>
</div>
        ...
        <div class="card" style="border-radius: 1.5rem !important; overflow: hidden;">
            ...
            <div class="card-body p-4">
                <form action="" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="dokter_id" class="form-label" style="font-weight: 600; color: #0f172a;">
                            <i class="fas fa-user-md me-1" style="color: #0d9488;"></i> Pilih Dokter
                        </label>
                    ...
                    <div class="mb-4">
                        <label for="klien_id" class="form-label" style="font-weight: 600; color: #0f172a;">
                            <i class="fas fa-user me-1" style="color: #7c3aed;"></i> Pilih Klien
                        </label>
                    ...
                    <div class="mb-4">
                        <label for="tanggal_janji" class="form-label" style="font-weight: 600; color: #0f172a;">
                            <i class="fas fa-clock me-1" style="color: #dc2626;"></i> Tanggal & Waktu Janji
                        </label>
