            ...
            <div class="card mb-4">
                <div class="card-body text-center">
                    ...
                    <div class="d-flex justify-content-center gap-2 mb-2">
                        ...
                        <a href="{{ route('hewan.edit', $detailHewan->id) }}">
                        ...
                        <form action="{{ route('hewan.hapus', ['jenis' => $detailHewan->jenis, 'id' => $detailHewan->id]) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                            <button  type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-danger" onclick="return confirm('Yakin hapus data ini?')">Hapus</button>
                        </form>
                    </div>
